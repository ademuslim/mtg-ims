...
// Notifikasi
$messageTypes = array('success_message', 'warning_message');
...
// Ambil data harga
// Mengambil semua data harga pada tabel data_harga, serta data deskripsi pada tabel data_produk
$dataHarga = ambilData('data_harga JOIN data_produk ON data_harga.id_produk = data_produk.id_produk', 'data_harga.*, data_produk.deskripsi');
?>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <td>
                                    <span class="action">
                                        <a href="edit.php?id=<?= $row['id_harga'] ?>" class="btn-action action-edit">
                                            <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960"
                                                width="24">
                                                <path
                                        ...
                                        <a href="del.php?id=<?= $row['id_harga'] ?>" class="btn-action action-del">
                                            <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960"
                                                width="24">
                                                <path
