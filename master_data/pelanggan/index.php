...
$dataPelanggan = ambilData('data_pelanggan', '*', null, 'id_pelanggan');
?>
                ...
                <div class="table-body">
                    <table>
                        ...
                        <tbody>
                            ...
                            ?>
                                <td><?= strtoupper($row['id_pelanggan']); ?></td>
                                ...
                                <td>
                                    <span class="action">
                                        ...
                                        <a href="del.php?id=<?= $row['id_pelanggan'] ?>" class="btn-action action-del">
                                            <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960"
                                                width="24">
                                                <path
