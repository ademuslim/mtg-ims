...
// Ambil data Kontak
$dataKontak = ambilData('data_kontak_internal', '*', null, 'id_kontak');
?>
    ...
    <div class="main-content">
        <div class="main-content-header">
            <div class="data-title">
                <h1>Data Kontak Internal</h1>
                <ul class="breadcrumbs">
                    <li><a href="<?= base_url('master_data/kontak_internal/index.php'); ?>">Data Kontak</a></li>
                </ul>
            </div>
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <span class="action">
                                        <a href="edit.php?id=<?= $row['id_kontak'] ?>" class="btn-action action-edit">
                                            <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960"
                                                width="24">
                                                <path
                                        ...
                                        <a href="del.php?id=<?= $row['id_kontak'] ?>" class="btn-action action-del">
                                            <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960"
                                                width="24">
                                                <path
