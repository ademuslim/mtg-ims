...
// Ambil data pemasok
$dataPemasok = ambilData('data_pemasok', '*', null, 'id_pemasok');
?>
                ...
                <div class="table-body">
                    <table>
                        ...
                        <tbody>
                            ...
                            ?>
                                <td><?= strtoupper($row['id_pemasok']); ?></td>
                                <td><?= strtoupper($row['nama_pemasok']); ?></td>
                                ...
                                <td>
                                    <span class="action">
                                        <a href="edit.php?id=<?= $row['id_pemasok'] ?>" class="btn-action action-edit">
                                            <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960"
                                                width="24">
                                                <path
                                        ...
                                        <a href="del.php?id=<?= $row['id_pemasok'] ?>" class="btn-action action-del">
                                            <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960"
                                                width="24">
                                                <path
