...
$dataProduk = ambilData('data_produk', '*', null, 'id_produk');
?>
                        ...
                        <tbody>
                            ...
                            if ($dataProduk){
                                ...
                                foreach ($dataProduk as $row) {
                                    ?>
                            <tr>
                                <td><?= strtoupper($row['id_produk']); ?></td>
                                ...
                                <td>
                                    <span class="action">
                                        <a href="edit.php?id=<?= $row['id_produk'] ?>" class="btn-action action-edit">
                                            <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960"
                                                width="24">
                                                <path
                                        ...
                                        <a href="del.php?id=<?= $row['id_produk'] ?>" class="btn-action action-del">
                                            <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960"
                                                width="24">
                                                <path
