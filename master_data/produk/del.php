...
$id_produk_to_delete = $_GET['id'];


// Pengecekan apakah id produk terdaftar pada tabel harga
$cek_produk_query = "SELECT id_produk FROM data_harga WHERE id_produk = '$id_produk_to_delete'";
...
hapusData('data_produk', "id_produk = '$id_produk_to_delete'", 'produk');
