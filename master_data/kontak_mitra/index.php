...
// Ambil data Kontak
$dataKontak = ambilData('data_kontak_mitra', '*', null, 'id_mitra');
?>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <td>
                                    <span class="action">
                                        <a href="edit.php?id=<?= $row['id_mitra'] ?>" class="btn-action action-edit">
                                            <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960"
                                                width="24">
                                                <path
                                        ...
                                        <a href="del.php?id=<?= $row['id_mitra'] ?>" class="btn-action action-del">
                                            <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960"
                                                width="24">
                                                <path
