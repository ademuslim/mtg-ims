        ...
        <div class="main-content-header">
            <div class="data-title">
                ...
                <ul class="breadcrumbs">
                    <li><a href="<?= base_url('master_data/kontak_mitra/index.php'); ?>">Data Kontak Mitra</a>
                    </li>
                    <li>Tambah Data Kontak Mitra</li>
                </ul>
            </div>
        ...
        <div class="main-content-body">
            <div class="form-wrapper">
                <div class="form-title">
                    <h2>Tambah Data Kontak Mitra</h2>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-data">
                                <textarea name="keterangan" id="keterangan"
                                    placeholder="Opsional (misal: Direktur PT XYZ, Sales Manager, Pelanggan Tetap, dll)."></textarea>
                            </div>
